...
class VisionAnalyzer:
    ...
    def _init_google(self):
        ...
        try:
            ...
            raise ImportError("google-cloud-vision package requis pour Google Vision")
        ...
        try:
            ...
            for i, timestamp in enumerate(timestamps):
                ...
                if result.returncode == 0 and frame_path.exists():
                    ...
                    log.debug(f"Frame extraite: {frame_path} (t={timestamp:.1f}s)")
                else:
            ...
            log.info(f"Extraction réussie: {len(frame_paths)} frames de {video_path.name}")
            return frame_paths
    ...
    def _analyze_with_openai(self, frame_paths: List[Path]) -> Dict:
        ...
        try:
            ...
            images = []
            for frame_path in frame_paths[:3]:  # Limiter à 3 frames pour les coûts
...
Focus on identifying the main subject, activity, and visual elements that would help categorize this content for YouTube."""
    ...
    def _analyze_with_google(self, frame_paths: List[Path]) -> Dict:
        ...
        try:
            ...
            content_type = self._determine_content_type(all_labels + all_objects)
...
Focus on identifying the main subject and activity shown."""
    ...
    def _determine_content_type(self, labels: List[str]) -> str:
        ...
        for keyword, category_id in self.CATEGORY_MAPPING.items():
            if keyword in label_text:
                ...
                category_scores[category_name] = category_scores.get(category_name, 0) + 1
    ...
    def _get_category_name(self, category_id: int) -> str:
        ...
        category_names = {
            20: "gaming", 27: "education", 24: "entertainment", 
            10: "music", 28: "technology", 25: "news", 
            17: "sports", 23: "comedy", 26: "howto", 
            22: "lifestyle", 19: "travel", 15: "pets",
            2: "automotive", 1: "film"
        }
    ...
    def get_category_id(self, content_type: str) -> int:
        ...
        return self.CATEGORY_MAPPING.get(content_type.lower(), 24)  # 24 = Entertainment par défaut
    ...
    def analyze_video(self, video_path: Path, num_frames: int = 3) -> Dict:
        ...
        try:
            ...
            log.info(f"Analyse terminée: {content_type} (catégorie {analysis['category_id']})")
            return analysis
