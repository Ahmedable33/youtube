...
def main():
    ...
    parser.add_argument("--schedule-dir", default="./schedule", help="Répertoire des tâches planifiées")
    parser.add_argument("--queue-dir", default="./queue", help="Répertoire de la queue normale")
    parser.add_argument("--archive-dir", default="./queue_archive", help="Répertoire des archives")
    ...
    try:
        run_scheduled_worker(args.schedule_dir, args.queue_dir, args.archive_dir, args.interval)
